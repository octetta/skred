...
proc toggle_button {num} {
  ...
  button .srec.rec -text keep -bg #37BC7D -relief flat -bd 0 -activebackground #FFFF99 -command { wire I1 ; .srec.info configure -text I1 }
  button .srec.stop -text drop -bg #F54927 -relief flat -bd 0 -activebackground #FFFF99 -command { wire I0 ; .srec.info configure -text I0 }
  label .srec.info -text I0
  
  pack .srec.rec -side left
  pack .srec.stop -side left
  pack .srec.info -side left
  pack .srec -anchor w
